...
def inputs(N):
	...
	#print(coords)
		...
		#t = random.randint(1, 25)
                ...
                o = euclidianDistance + random.randint(-1 * euclidianDistance, 600 - euclidianDistance)
                c = o * 2 + random.randint(math.ceil(-0.5 * euclidianDistance), 600 - euclidianDistance)
