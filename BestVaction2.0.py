...
def main():
    ...
    directory = os.fsencode(r"C:\Users\dfgre\Documents\Theory of Algorithms\Project\inputs")
    ...
    for file in os.listdir(directory):
        ...
        if filename.endswith(".in"): 
            ...
            combined = r"C:\Users\dfgre\Documents\Theory of Algorithms\Project\inputs" + str("/") + str(filename)
            f = open(combined, "r")
            ...
            combined2 = r"C:\Users\dfgre\Documents\Theory of Algorithms\Project\all_outputs" + str("/") + str(filename)
            combined2 = combined2.replace(".in", ".out")
            combined2 = combined2[0:max(len(combined2) - 3, 0)]
